...
//private ArrayList <ProtocolManagerAnalysisStartListener> listeners = new ArrayList <ProtocolManagerAnalysisStartListener>();
   ...
   // protected ArrayList<ExploreStepBlockGUI> ExploreStepsList = new ArrayList<ExploreStepBlockGUI>();
    ...
    private void initComponents() {
        ...
        PreProcessing_Panel.setMaximumSize(new java.awt.Dimension(300, 400));
        PreProcessing_Panel.setMinimumSize(new java.awt.Dimension(300, 360));
        PreProcessing_Panel.setPreferredSize(new java.awt.Dimension(300, 360));
        ...
        Object_Panel.setPreferredSize(new java.awt.Dimension(440, 360));
...
//                    thumb.setVisible(true);
        ...
        public void onChangeSetup(ArrayList al2) {
            ...
            Object.setText("Method: " + VTC._VTC.PROCESSOPTIONS[(Integer)al.get(1)] + ", Segment by: " + Channels.get((Integer)al.get(0)).toString());
...
//get the arraylist, decide the nubmer of steps, by .steps to do and whether this is a preview or final by .type
        ...
        for(int i = 0; i <= this.ProcessedImage.getNChannels()-1; i++){
        this.ProcessedImage.setC(i);
        this.ProcessedImage.getChannelProcessor().setLut(LUT.createLutFromColor(Color.WHITE));
        this.ProcessedImage.setZ(Math.round(this.ProcessedImage.getNSlices()/2));
        this.ProcessedImage.resetDisplayRange();
        }
        //this.ProcessedImage.getProcessor().setLut(LUT.createLutFromColor(Color.WHITE));
