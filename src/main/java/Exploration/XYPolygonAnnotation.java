...
public class XYPolygonAnnotation extends AbstractXYAnnotation
     ...
     *
     * @param polygon the coordinates of the polygon's vertices (null not
     * permitted).
     */
     ...
     * specified stroke and outlinePaint. The array of polygon coordinates must
     * contain an even number of coordinates (each pair is an (x, y) location on
     * the plot) and the last point is automatically joined back to the first
     * point.
     *
     * @param polygon the coordinates of the polygon's vertices (null not
     * permitted).
     ...
     *
     * @return The outline paint (possibly null).
     *
     * @since 1.0.2
     */
...
//All code examples are from open source projects from GitHub and SourceForge
