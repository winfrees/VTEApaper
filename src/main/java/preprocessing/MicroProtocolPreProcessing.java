...
public class MicroProtocolPreProcessing extends java.lang.Object {
    ...
    public MicroProtocolPreProcessing(ImagePlus imp, ArrayList protocol) {
        ...
        //take Arraylist appart, expects and array list of object array
    ...
    ;
    //private String[] ProcessOptions = {"Background Subtraction", "Enhance Contrast", "Reduce Noise"}; 
    
    private void ProcessManager(ArrayList steps) {
        IJ.log("Preprocess step: " + steps.get(0).toString());
        IJ.log("Position 1: " + steps.get(1).toString());
        IJ.log("Position 2: " + steps.get(2).toString());
    ...
    private void SubtractBackground(ArrayList variables) {
        ...
        IJ.log("Process items = " + radius.getText() + "," + paraboloid + "," + all);
        //IJ.run(this.imp1, "Subtract Background...", "rolling=" + radius.getText() + " " + paraboloid + " " + all);
        IJ.log("IJ.run(this.imp1, Subtract Background..., rolling=" + radius.getText() + " " + paraboloid + " " + all);
    }
    ...
    private void EnhanceContrast(ArrayList variables) {
        ...
        //IJ.run(this.imp1, "Enhance Contrast...", "saturated="+fractionsaturated.getText()+" "+normalize.getText()+" "+equalize.getText()+" "+stack.getText()+" "+stackhistogram.getText())
        IJ.run(this.imp1, "Enhance Contrast...", "saturated=" + fractionsaturated.getText() + " " + norm + " " + equal + " " + stackall + " " + stackhisto);
        IJ.log("IJ.run(this.imp1, \"Enhance Contrast...\", \"saturated=" + fractionsaturated.getText() + " " + norm + " " + equal + " " + stackall + " " + stackhisto);
